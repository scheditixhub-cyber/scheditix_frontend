...
const ForgetVerification: React.FC = () => {
            ...
            <div className="w-100 rounded-lg sm:shadow-md h-max bg-none sm:bg-white flex flex-col items-start sm:items-center sm:px-10 sm:py-10 gap-4">
              ...
              >
                <div className="w-full h-max flex justify-between gap-2">
                  {otp.map((data, index) => (
                    <input
                      ...
                      onPaste={handlePaste}
                      className="w-10 h-10 rounded flex items-center justify-center border border-gray-300 text-center bg-white sm:bg-none outline-none focus:border-[#27187E] transition-all"
                    />
                  ))}
                </div>
                ...
                <div className="w-full h-max flex flex-col items-center gap-2 mt-2">
                  ...
                  >
                    Resend Code {timer > 0 && <span>({formatTime()})</span>}
                  </button>
                </div>
              </form>
            </div>
